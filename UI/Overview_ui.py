...
class Ui_Overview(object):
    def setupUi(self, Overview):
        ...
        self.pushButton.setGeometry(QRect(80, 50, 200, 200))
        self.pushButton_2 = QPushButton(Overview)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(80, 300, 200, 200))
        self.pushButton_3 = QPushButton(Overview)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(80, 550, 200, 200))
        self.AddButton = QPushButton(Overview)
        self.AddButton.setObjectName(u"AddButton")
        self.AddButton.setGeometry(QRect(280, 780, 40, 40))
        font1 = QFont()
